...
public:
    ...
    void updateDetails(const string& name, int code, int credit, const string& instructorName, const string& desc) {
        courseName = name;
        courseCode = code;
        credits = credit;
...
int main() {
    ...
    // Update details of c1
    c1.updateDetails("Statistics", 104, 3, "Prof. Davis", "Probability and Statistics");
